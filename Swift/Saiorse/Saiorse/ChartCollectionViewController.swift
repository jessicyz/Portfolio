...
class ChartCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(loadList), name: NSNotification.Name(rawValue: "loadChartCollection"), object: nil)
    }
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        // Configure the cell
        if let item = chartModel.getChartAt(at: indexPath.item) {
            cell.name.text = item.getChartName()
