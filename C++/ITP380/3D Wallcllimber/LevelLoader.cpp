...
//                    In LevelLoader::Load, when creating a Checkpoint, use GetStringFromJSON to get the
//                    “level” property name, if it exists (the syntax is similar to what you did to get the respawn
//                                                         position for the player). Then set the mLevelString variable to that
